...
int main() {
	...
	world->add(std::make_shared<sphere3d>(vec3(0, -1000, 0), 1000, ground_material));
	for (int a = -5; a < 5; a++) {
		for (int b = -5; b < 5; b++) {
	...
	world->add(std::make_shared<sphere3d>(vec3(0, 1, 0), 1.0, material1));
	world->add(std::make_shared<sphere3d>(vec3(-4, 1, 0), 1.0, material2));
	world->add(std::make_shared<sphere3d>(vec3(4, 1, 0), 1.0, material3));
